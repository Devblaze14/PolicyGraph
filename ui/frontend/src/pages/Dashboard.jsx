...
const STATS = [
    { icon: ShieldCheck, label: "Policies Indexed", value: "1,245", trend: "+12.5%", color: "text-indigo-400", bg: "bg-indigo-500/10" },
    { icon: FileStack, label: "Documents Processed", value: "8,930", trend: "+5.1%", color: "text-cyan-400", bg: "bg-cyan-500/10" },
    { icon: Zap, label: "Queries Answered", value: "45.2k", trend: "+24.3%", color: "text-emerald-400", bg: "bg-emerald-500/10" },
    { icon: Database, label: "Graph Nodes", value: "125.6k", trend: "+8.4%", color: "text-amber-400", bg: "bg-amber-500/10" },
]
